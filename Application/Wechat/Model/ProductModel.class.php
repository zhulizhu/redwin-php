...
class ProductModel extends Model{
	 ...
	 * @return array              文档列表
	 */
	public function lists($category, $order = '`level` DESC', $status = 1, $field = true,$addon = false){
	 ...
	 * @return array              文档列表
	 */
	public function Screening($category,$productId,$order = '`id` DESC', $status = 1, $field = true,$addon = false){
		$Child = D('Procate')->getChildrenId($category);
