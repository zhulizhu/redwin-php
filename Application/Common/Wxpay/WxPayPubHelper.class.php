...
class Commonutilpub
{
	...
	function postXmlSSLCurl($xml,$url,$second=30)
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT, getcwd().WxPaypubconfig::SSLCERT_PATH);
		//默认格式为PEM，可以注释
		curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
		curl_setopt($ch,CURLOPT_SSLKEY, getcwd().WxPaypubconfig::SSLKEY_PATH);
		//post提交方式
		curl_setopt($ch,CURLOPT_POST, true);
		curl_setopt($ch,CURLOPT_POSTFIELDS,$xml);
		$data = curl_exec($ch);
 ...
 * 退款申请接口
 */
class Refund_pub extends Wxpayclientpub
{
 ...
 * 对账单接口
 */
class DownloadBill_pub extends Wxpayclientpub
{
 ...
 * 短链接转换接口
 */
class ShortUrl_pub extends Wxpayclientpub
{
	function __construct() 
	{
		//设置接口链接
 ...
 * 请求商家获取商品信息接口
 */
class NativeCall_pub extends Wxpayserverpub
{
	/**
	 * 生成接口参数xml
	 */
 ...
 * 静态链接二维码
 */
class NativeLink_pub  extends Commonutilpub
{
