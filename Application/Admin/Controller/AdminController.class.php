...
class AdminController extends Controller {
    ...
    protected function _initialize(){
        ...
        $this->assign("nowgroupid",$group['id']);
    ...
    final public function getMenus($controller=CONTROLLER_NAME){
    	...
    	if($group['id']>11 && $group['id']<14){
    		$menus['main'][0] = array("id"=>1,"title"=>"首页","pid"=>0,"sort"=>0,"url"=>"User/index","hide"=>0,"tip"=>"","group"=>"","is_dev",0);
    		$menus['child']['用户管理'][0] = array("id"=>17,"pid"=>1,"title"=>"用户信息","url"=>"User/index","tip"=>"");
    		$menus['child']['订单管理'][0] = array("id"=>18,"pid"=>1,"title"=>"全部","url"=>"Order/index","tip"=>"");
    		$menus['child']['订单管理'][1] = array("id"=>18,"pid"=>1,"title"=>"待付款","url"=>"Order/index?status=0","tip"=>"");
    		$menus['child']['订单管理'][2] = array("id"=>18,"pid"=>1,"title"=>"待收货","url"=>"Order/index?status=1","tip"=>"");
    		$menus['child']['订单管理'][3] = array("id"=>18,"pid"=>1,"title"=>"待评价","url"=>"Order/index?status=2","tip"=>"");
    		$menus['child']['订单管理'][4] = array("id"=>18,"pid"=>1,"title"=>"已完成","url"=>"Order/index?status=3","tip"=>"");
    		$menus['child']['订单管理'][5] = array("id"=>18,"pid"=>1,"title"=>"已退款","url"=>"Order/index?status=5","tip"=>"");
    	}else{
