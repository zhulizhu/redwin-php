...
<body>
	...
	<!-- /表格列表 -->
  	<form action="/Admin/WechatMenu/add.html" method="post" class="form-horizontal" >
    	<?php if( $pid != 0 ): ?><div class="form-item">
            	<label class="item-label">上级菜单<span class="check-tips">（上级菜单）</span></label>
            	<div class="controls">
                	<input type="text" class="text input-large" disabled="disabled" value="<?php echo ($topname); ?>" />
            	</div>
        	</div><?php endif; ?>
      	<div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
				...
				<label class="inline radio"><input type="radio" name="type" value="4">打开商城</label>
				<label class="inline radio"><input type="radio" name="type" value="5">打开网站</label>
            </div>
        </div>
        <div class="box">
        	<div class="form-item">
            	...
            	<div class="controls">
                	<label class="textarea">
                		<textarea name="content1"><?php echo ($info["content"]); ?></textarea>
                    	<?php echo hook('adminArticleEdit', array('name'=>content1,'value'=>$info.content,'height'=>200,'editor_type'=>4));?>
                	</label>
            	</div>
        	</div>
							...
							<div class="data-table">
        						<div class="data-table table-striped">
									<table class="">
    									...
    									<tbody>
											<tr>
            									<td><input class="ids" type="radio" name="ids[]" value="<?php echo ($vo["id"]); ?>" /></td>
												<td><?php echo ($vo["id"]); ?> </td>
												<td><?php echo ($vo["name"]); ?></td>
												<td><a data-id="<?php echo ($vo["id"]); ?>" href="<?php echo U('Linkage/index?pid='.$vo['id']);?>"><?php echo ($vo["title"]); ?></a></td>
            ...
            <div class="form-item" style="display:none;">
            	...
            	<div class="controls">
                	<input type="text" class="text input-large" name="content[]" value="<?php echo ($info["name"]); ?>" />
            	</div>
        	</div>
            <div class="form-item" style="display:none;">
	...
	<link rel="stylesheet" type="text/css" href="/Public/Admin/bootstrap/css/modal.css">
<script src="/Public/Admin/bootstrap/js/bootstrap.min.js"></script>
	...
	$(function(){
        ...
        //导航高亮
        highlight_subnav('<?php echo U('Wechat/menu');?>');
    </script>
