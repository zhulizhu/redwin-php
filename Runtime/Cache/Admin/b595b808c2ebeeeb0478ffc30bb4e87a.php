...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.copyright').html('<div class="copyright"> ©2013 <a href="http://www.cheewo.com" target="_blank">cheewo.com</a> 成都智网天下科技有限公司版权所有</div>');
        $('.sidebar').remove();
    })
	
	var $window = $(window);
            $window.resize(function(){
                $("#main").css("min-height", $window.height() -81);
            }).resize();
</script>
