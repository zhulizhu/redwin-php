    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Upgroup/index.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (get_group_title_by_id($menu["group_id"])); ?></td>
                        <td><?php echo (get_group_title_by_id($menu["to_group_id"])); ?></td>
                        <td><?php echo ($menu["shopping_price"]); ?></td>
                        <td><?php echo ($menu["team_price"]); ?></td>
                        <td><?php echo ($menu["shopping_num"]); ?></td>
                        <td><?php echo ($menu["sanji_num"]); ?></td>
                        <td><?php echo ($menu["erji_num"]); ?></td>
                        <td><?php echo ($menu["yiji_num"]); ?></td>
                        <td><?php echo ($menu["bzj"]); ?></td>
                        <td><?php echo (get_autoup($menu["autoup"])); ?></td>
                        <td>
